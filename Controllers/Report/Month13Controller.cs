...
{
    [ModuleAuthorize("RPTthe13thMonthM")]
    public class Month13Controller : Controller
    {
        private readonly IDbConnection _db;

        public Month13Controller(IDbConnection db)
        {
            _db = db;
        }
        ...
        {
            return View("~/Views/Report/Month13.cshtml");
        }
